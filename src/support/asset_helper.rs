...
pub fn eth() -> ExtendedAsset {
	...
	ExtendedAsset {
		asset: Asset {
			id: 4543560,
			version: 1,
			short_name: polkadot::runtime_types::primitive_types::U256(U256::from("0x457468657265756D").0),
			is_tradable: true,
			is_collateral: false,
			decimals: 18,
		},
        asset_addresses:polkadot::runtime_types::bounded_collections::bounded_vec::BoundedVec(asset_addresses.to_vec()),
...
pub fn btc() -> ExtendedAsset {
	...
	ExtendedAsset {
		asset: Asset {
			id: 4346947,
			version: 1,
			short_name:polkadot::runtime_types::primitive_types::U256(U256::from("0x426974636F696E").0),
			is_tradable: true,
			is_collateral: false,
			decimals: 6,
		},
...
pub fn usdc() -> ExtendedAsset {
	...
	asset_addresses
		.force_push(AssetAddress { chain: Chains::starknet_chain(),
             address: polkadot::runtime_types::primitive_types::U256(U256::from(200).0) });
	asset_addresses
		.force_push(AssetAddress { chain: Chains::zkx_sync_chain(), 
	...
	ExtendedAsset {
		asset: Asset {
			id: 1431520323,
			version: 1,
			short_name: polkadot::runtime_types::primitive_types::U256(U256::from("0x55534420436972636C65").0),
			is_tradable: false,
			is_collateral: true,
			decimals: 6,
		},
