...
pub fn convertToFixedI128(num: FixedI128) -> 
...
pub fn convert_to_u256(num: U256) ->
polkadot::runtime_types::primitive_types::U256 {
	polkadot::runtime_types::primitive_types::U256(num.0)
}

pub fn convert_to_polkadot_order(order: Order) -> 
...
pub fn convert_to_order_type(order_type: OrderType) ->
polkadot::runtime_types::pallet_support::types::trading::OrderType {

	match order_type {
		OrderType::Limit => polkadot::runtime_types::pallet_support::types::trading::OrderType::Limit,
		OrderType::Market => polkadot::runtime_types::pallet_support::types::trading::OrderType::Market,
		_ => polkadot::runtime_types::pallet_support::types::trading::OrderType::Forced,
	}
}

pub fn convert_to_direction(direction: Direction) -> 
...
pub fn convert_to_side(side: Side) -> 
...
pub fn convert_to_time_in_force(tif: TimeInForce) -> 
polkadot::runtime_types::pallet_support::types::trading::TimeInForce {

	match tif {
		TimeInForce::FOK => polkadot::runtime_types::pallet_support::types::trading::TimeInForce::FOK,
		TimeInForce::GTC => polkadot::runtime_types::pallet_support::types::trading::TimeInForce::GTC,
		_ => polkadot::runtime_types::pallet_support::types::trading::TimeInForce::IOC
	}
}

pub fn convert_to_signature_info(sig: SignatureInfo) -> 
...
pub fn convert_to_hash_type(hash_type: HashType) -> 
polkadot::runtime_types::pallet_support::types::common::HashType {

	match hash_type {
		HashType::Pedersen => polkadot::runtime_types::pallet_support::types::common::HashType::Pedersen,
		_ => polkadot::runtime_types::pallet_support::types::common::HashType::Poseidon
	}
}

pub fn convert_to_polkadot_base_fee(base_fees: Vec<BaseFee>) ->
Vec<polkadot::runtime_types::pallet_support::types::trading_fees::BaseFee> {

	let mut ret_base_fees = vec![];
	for base_fee in base_fees {
		let converted_base_fee = polkadot::runtime_types::pallet_support::types::trading_fees::BaseFee {
